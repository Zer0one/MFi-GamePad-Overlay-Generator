...
btnReset[0]="reset"					;btnReset[1]="rect"			;btnReset[2]="0.038"		;btnReset[3]="0.04"			;btnReset[4]="reset_square_text.png"	;btnReset[5]="0.068"		;btnSelectCon[6]="0.0225"

## Common - B(utton) G(roup) P(osition) Table
# Top Group (Landscape)
bgpTopX_L[0]="0.05"	 ;bgpTopY_L[0]="0.09"	# Show Button
bgpTopX_L[1]="0.3"	 ;bgpTopY_L[1]="0.09"	# # Shader Previous
bgpTopX_L[2]="0.4"	 ;bgpTopY_L[2]="0.09"	# Button Mode Switch Button
bgpTopX_L[3]="0.5"	 ;bgpTopY_L[3]="0.17"	# Menu Toggle Button
bgpTopX_L[4]="0.6"	 ;bgpTopY_L[4]="0.09"	# Orientation Switch Button
bgpTopX_L[5]="0.7"	 ;bgpTopY_L[5]="0.09"	# Shader Next
...
bgpTopX_P[1]="0.23"	 ;bgpTopY_P[1]="0.05"	# Shader Previous
bgpTopX_P[2]="0.36"	 ;bgpTopY_P[2]="0.085"	# Button Mode Switch Button
bgpTopX_P[3]="0.5"	 ;bgpTopY_P[3]="0.145"	# Menu Toggle Button
bgpTopX_P[4]="0.64"	 ;bgpTopY_P[4]="0.085"	# Orientation Switch Button
bgpTopX_P[5]="0.77"	 ;bgpTopY_P[5]="0.05"	# Shader Next
...
bgpBtmX_P[0]="0.09"	 ;bgpBtmY_P[0]="0.944"	# Save Show/Hide Button (Left)
...
bgpBtmX_P[4]="0.91"	 ;bgpBtmY_P[4]="0.944"	# Save Show/Hide Button (Right)
...
tarId_orie[0]=""	# Orientation mode					- Defined Next - Change every  12
tarId_savM[0]=""	# Save controls visualization mode	- Defined Next - Change every  6
tarId_btnM[0]=""	# Thumb buttons mode				- Defined Next - Change every  3
tarId_show[0]=""	# Visualization level				- Defined Next - Change every  1

# Per Targets ID Name - List definition
tarId_Name[0]=""	# Defined Next

# Redirection "Tables" definition
tarTableShow[0]=""   	# Visualization level control (Show)		- Defined Next
tarTableHide[0]=""   	# Visualization level control (Hide)		- Defined Next
...
for tarCount in `seq 0 $tarTot`; do
	...
	case "${tarId_orie[$tarCount]}" in
		"${orie[0]}")
			...
			bgpTopX_[0]=${bgpTopX_L[0]} ;bgpTopY_[0]=${bgpTopY_L[0]}	;bgpSavX_[0]=${bgpSavX_L[0]} ;bgpSavY_[0]=${bgpSavY_L[0]}	;bgpTmbX_[0]=${bgpTmbX_L[0]} ;bgpTmbY_[0]=${bgpTmbY_L[0]}	;bgpBtmX_[1]=${bgpBtmX_L[1]} ;bgpBtmY_[1]=${bgpBtmY_L[1]}
			bgpTopX_[1]=${bgpTopX_L[1]} ;bgpTopY_[1]=${bgpTopY_L[1]}	;bgpSavX_[1]=${bgpSavX_L[1]} ;bgpSavY_[1]=${bgpSavY_L[1]}	;bgpTmbX_[1]=${bgpTmbX_L[1]} ;bgpTmbY_[1]=${bgpTmbY_L[1]}	;bgpBtmX_[3]=${bgpBtmX_L[3]} ;bgpBtmY_[3]=${bgpBtmY_L[3]}
			...
			bgpTopX_[6]=${bgpTopX_L[6]} ;bgpTopY_[6]=${bgpTopY_L[6]}	;bgpSavX_[5]=${bgpSavX_L[5]} ;bgpSavY_[5]=${bgpSavY_L[5]}	;bgpTmLX_[1]=${bgpTmLX_L[1]} ;bgpTmLY_[1]=${bgpTmLY_L[1]}
		...
		"${orie[1]}")
			...
			# Group 1 (Top)												# Group 2 (Sav)												# Group 3A (Tmb)											# Group 4 (Btm)
			bgpTopX_[0]=${bgpTopX_P[0]} ;bgpTopY_[0]=${bgpTopY_P[0]}	;bgpSavX_[0]=${bgpSavX_P[0]} ;bgpSavY_[0]=${bgpSavY_P[0]}	;bgpTmbX_[0]=${bgpTmbX_P[0]} ;bgpTmbY_[0]=${bgpTmbY_P[0]}	;bgpBtmX_[1]=${bgpBtmX_P[1]} ;bgpBtmY_[1]=${bgpBtmY_P[1]}
			bgpTopX_[1]=${bgpTopX_P[1]} ;bgpTopY_[1]=${bgpTopY_P[1]}	;bgpSavX_[1]=${bgpSavX_P[1]} ;bgpSavY_[1]=${bgpSavY_P[1]}	;bgpTmbX_[1]=${bgpTmbX_P[1]} ;bgpTmbY_[1]=${bgpTmbY_P[1]}	;bgpBtmX_[3]=${bgpBtmX_P[3]} ;bgpBtmY_[3]=${bgpBtmY_P[3]}
			...
			bgpTopX_[6]=${bgpTopX_P[6]} ;bgpTopY_[6]=${bgpTopY_P[6]}	;bgpSavX_[5]=${bgpSavX_P[5]} ;bgpSavY_[5]=${bgpSavY_P[5]}	;bgpTmLX_[1]=${bgpTmLX_P[1]} ;bgpTmLY_[1]=${bgpTmLY_P[1]}
...
#	echo ${tarId_show_orie[$tarCount]}","${orie[0]}","${orie[1]}
	...
	# Visualization Level - _Initial Buttons (Commons)
	echo ""																																							| tee -a "$fileName$fileName_con.$fileExt" "$fileName$fileName_Low$fileName_con.$fileExt" "$fileName$fileName_arc.$fileExt" "$fileName$fileName_Low$fileName_arc.$fileExt"	> /dev/null
	...
	echo "overlay"$tarCount"_desc1 = \""${btnHide[0]}","${bgpTopX_[6]}","${bgpTopY_[6]}","${btnHide[1]}","${btnHide_[2]}","${btnHide_[3]}"\""						| tee -a "$fileName$fileName_con.$fileExt" "$fileName$fileName_Low$fileName_con.$fileExt" "$fileName$fileName_arc.$fileExt" "$fileName$fileName_Low$fileName_arc.$fileExt"	> /dev/null
	...
	echo "overlay"$tarCount"_desc8 = \""${btnSelectCon[0]}","${bgpBtmX_[1]}","${bgpBtmY_[1]}","${btnSelectCon[1]}","${btnSelectCon_[2]}","${btnSelectCon_[3]}"\""	| tee -a "$fileName$fileName_con.$fileExt" "$fileName$fileName_Low$fileName_con.$fileExt"																					> /dev/null
	...
	echo "overlay"$tarCount"_desc9 = \""${btnStartCon[0]}","${bgpBtmX_[3]}","${bgpBtmY_[3]}","${btnStartCon[1]}","${btnStartCon_[2]}","${btnStartCon_[3]}"\""		| tee -a "$fileName$fileName_con.$fileExt" "$fileName$fileName_Low$fileName_con.$fileExt"																					> /dev/null
	...
	# Console Specific Buttons
	echo "overlay"$tarCount"_desc8 = \""${btnSelectArc[0]}","${bgpBtmX_[1]}","${bgpBtmY_[1]}","${btnSelectArc[1]}","${btnSelectArc_[2]}","${btnSelectArc_[3]}"\""	| tee -a "$fileName$fileName_arc.$fileExt" "$fileName$fileName_Low$fileName_arc.$fileExt"																					> /dev/null
	...
	echo "overlay"$tarCount"_desc9 = \""${btnStartArc[0]}","${bgpBtmX_[3]}","${bgpBtmY_[3]}","${btnStartArc[1]}","${btnStartArc_[2]}","${btnStartArc_[3]}"\""		| tee -a "$fileName$fileName_arc.$fileExt" "$fileName$fileName_Low$fileName_arc.$fileExt"																					> /dev/null
